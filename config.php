...
if (!defined('BOT_OWNER_ID'))                      define('BOT_OWNER_ID', '7237320756');

if (!defined('BOT_NAME'))               define('BOT_NAME', 'BETA');
if (!defined('BOT_USERNAME'))               define('BOT_USERNAME', 'BravCc_Bot');
if (!defined('BOT_TOKEN'))                       define('BOT_TOKEN', '8170080784:AAEOIpV0QB_TCoof1F-KEjkXWorpAAvEvR8');
if (!defined('BOT_LOGS'))                       define('BOT_LOGS', '-4194518429');
if (!defined('BOT_GROUP'))                       define('BOT_GROUP', '-1002493542474');
